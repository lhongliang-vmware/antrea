...
import (
	...
	types "antrea.io/antrea/pkg/agent/proxy/types"
...
func (m *MockInterface) AddNodePort(arg0 map[int][]net.IP, arg1 *types.ServiceInfo, arg2 bool) error {
	m.ctrl.T.Helper()
...
// InitNodePort mocks base method
func (m *MockInterface) InitNodePort(arg0 map[int][]net.IP, arg1 bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InitNodePort", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// InitNodePort indicates an expected call of InitNodePort
func (mr *MockInterfaceMockRecorder) InitNodePort(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitNodePort", reflect.TypeOf((*MockInterface)(nil).InitNodePort), arg0, arg1)
}
