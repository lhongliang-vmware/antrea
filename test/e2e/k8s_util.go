...
func (k *KubernetesUtils) CreateOrUpdateCG(cg *corev1a2.ClusterGroup) (*corev1a2.ClusterGroup, error) {
...
func (k *KubernetesUtils) CreateCG(name string, pSelector, nSelector *metav1.LabelSelector, ipBlock *secv1alpha1.IPBlock) (*corev1a2.ClusterGroup, error) {
...
func (k *KubernetesUtils) CreateLegacyCG(name string, pSelector, nSelector *metav1.LabelSelector, ipBlock *secv1alpha1.IPBlock) (*legacycorev1a2.ClusterGroup, error) {
